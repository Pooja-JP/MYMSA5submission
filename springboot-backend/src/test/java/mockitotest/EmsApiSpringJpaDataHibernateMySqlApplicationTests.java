...
public class EmsApiSpringJpaDataHibernateMySqlApplicationTests {
	...
	public void addEmployeeTest() throws Exception {
		...
		employee.setLastName("J P");
		employee.setEmailId("poojajp@gmail.com");
	...
	public void getAllEmployeeTest() throws Exception {
		...
		String resultContent = result.getResponse().getContentAsString();
		Response response = om.readValue(resultContent, Response.class);
		Assert.assertTrue(((Response) response).isSuccess() == true);
	}
	...
	public void getEmployeeTest() throws Exception {
		...
		String resultContent = result.getResponse().getContentAsString();
		Response response = om.readValue(resultContent, Response.class);
		Assert.assertTrue(((Object) response).isSuccess() == true);
	}
